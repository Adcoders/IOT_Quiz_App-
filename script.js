const quizData = {
  ...
  "Week 7": [
    ...
    },
    {
      ...
      options: ["a. Tree", "b. Flat", "c. Mesh", "d. Line"],
      answer: "a. Tree",
    },
    {
      question:
  ...
  "Week 8": [
    {
      ...
      answer: "c. An SDN protocol tailored for IoT devices",
    },
    {
      question:
      ...
      answer: "b. Mobi-Flow < Conventional",
    },
    {
    ...
    },
    {
      ...
      options: ["a. Private Cloud", "b. Public cloud", "c. IaaS", "d. PaaS"],
    ...
    },
    {
      ...
      answer: "d. All of Network, Host and Application Level Security.",
    },
    {
      question:
        "Data security and client authentication is an issue in which of the following cloud service models?",
      options: ["a. SaaS", "b. SaaS and PaaS", "c. IaaS", "d. All of them"],
    ...
    },
    {
      ...
      answer: "b. To provide a platform for executing virtual machines",
    },
    {
    ...
    },
    {
      ...
      options: ["a. Scalable", "b. Reliability", "c. Agile", "d. Ubiquitous"],
      answer: "d. Ubiquitous",
    },
  ],
  // <!-------------------------------------------- WEEK 9---------------------------------------------------------->
  "Week 9": [
    ...
    },
    {
      ...
      options: ["A) Suse", "B) Nova", "C) Swift", "D) All of these"],
      answer: "A) Suse",
    },
    {
      question: "Who coined the term Fog computing?",
      options: ["A) IBM", "B) CISCO", "C) All of these", "D) None of these"],
      answer: "B) CISCO",
    },
    {
      question:
        "Fill in the blank. The concept of ________ enables physical hardware to be shared among multiple entities.",
      options: [
    ...
    },
    {
      ...
      options: ["A) Horizon", "B) Heat", "C) Stellar", "D) Neutron"],
      answer: "C) Stellar",
    },
    {
      question:
    ...
    {
      question:
        "The optimal composition of __________ is a management issue in sensor-cloud.",
      options: [
        "A) Logistics",
        "B) Pricing",
        "C) Caching",
    ...
    },
    {
      ...
      options: ["A) 10s", "B) 5s", "C) 15s", "D) 20s"],
      answer: "B) 5s",
    },
    {
    ...
    },
    {
      ...
      options: ["A) Horizon", "B) Glance", "C) Neutron", "D) None of these"],
      answer: "A) Horizon",
    },
  ],
  // <!-------------------------------------------- WEEK 10---------------------------------------------------------->
  "Week 10": [
    ...
    },
    {
      ...
      options: [
        "a. Efficient auto-routing of vehicles",
        "b. Locating current vacant spots",
    ...
    },
    {
      ...
      answer: "d. Multi-sensor data fusion",
    },
    {
      question:
    ...
    },
    {
      ...
      options: [
        "a. Uninterrupted Post-messaging",
        "b. Universal Pull Streaming",
        "c. Universal Plug and Play",
        "d. Unhindered Public Networking",
      ],
      answer: "c. Universal Plug and Play",
    },
    {
    ...
    {
      question:
        "Mobility of vehicles in a V2X environment limit which of the following that restricts the use of TCP/IP for V2X communication?",
      options: [
        "a. Communication between vehicular infrastructure",
        "b. Localization of data",
        "c. Backbone routing in IP core networks",
        "d. Human-vehicle interaction",
      ],
      answer: "b. Localization of data",
    },
  ],
  // <!-------------------------------------------- WEEK 11---------------------------------------------------------->
  "Week 11": [{
